...
classDiagram
    ...
    class IAttributeManager {
        <<interface>>
        +float GetAttribute(string attributeId)
        +float GetAttribute(string attributeId, AttributeType type)
